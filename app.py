...
st.subheader("② AI节能策略示例（基于样例数据自动生成）")
...
st.subheader("③ 阶段性成果总结（示例）")

st.success("""
- 完成单栋教学楼 1 层样板间部署（数据模拟）。
- 生成 6 间教室的节能策略集，覆盖空调/照明/插座自动控制。
- 月均节能效果模拟值为 18–25% 区间，与高校节能改造参考值一致。
- 已形成可展示的 Demo 网页，可用于答辩现场演示、PPT 成果展示。
""")